...
use std::io::{Write};
use napi::{CallContext, JsObject, JsUndefined, JsBoolean, JsNumber, Result as NResult, Error as NapiError, JsString};
...
pub fn arg_to_number<N: TryFrom<JsNumber, Error = napi::Error>>(ctx: &CallContext, arg: usize) -> NResult<N> {
